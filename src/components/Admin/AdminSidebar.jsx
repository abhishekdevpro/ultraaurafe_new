  ...
  const fetchAdmin = async () => {
    try {
      const response = await axios.get(
        "https://api.novajobs.us/api/uaadmin/profile",
        {
          headers: {
            Authorization: token,
          },
              ...
              <div className="settings-widget account-settings">
                <div className="settings-menu">
                  ...
                  <ul>
                    <li
                      className={`nav-item ${
                        isPathActive("/admin/admin-dashboard") ||
                    ...
                    <li
                      className={`nav-item ${
                        isPathActive("/admin/course-list") ? "active" : ""
                      }`}
                    >
                    ...
                    <li
                      className={`nav-item ${
                        isPathActive("/admin/notes-list") ? "active" : ""
                      }`}
                    >
                      <Link to="/admin/notes-list" className="nav-link">
                        <i className="bx bxs-book" />
                        Notes List
                      </Link>
                    </li>
                    ...
                    <li
                      className={`nav-item ${
                        isPathActive("/admin/trainers") ||
                        isPathActive("/admin/trainer-list")
                          ? "active"
                          : ""
                      }`}
                    >
                    ...
                    <li
                      className={`nav-item ${
                        isPathActive("/admin/add-trainer") ? "active" : ""
                      }`}
                    >
                    ...
                    <li
                      className={`nav-item ${
                        isPathActive("/admin/students") ||
                        isPathActive("/admin/student-list")
                          ? "active"
                          : ""
                      }`}
                    >
                    ...
                    <li
                      className={`nav-item ${
                        isPathActive("/admin/connect-trainer") ? "active" : ""
                      }`}
                    >
                    ...
                    <li
                      className={`nav-item ${
                        isPathActive("/admin/add-student") ? "active" : ""
                      }`}
                    >
                    ...
                    <li
                      className={`nav-item ${
                        isPathActive("/admin/partner-list") ? "active" : ""
                      }`}
                    >
                    ...
                    <li
                      className={`nav-item ${
                        isPathActive("/admin/add-coupon") ? "active" : ""
                      }`}
                    >
                    ...
                    <li
                      className={`nav-item ${
                        isPathActive("/admin/coupon-list") ? "active" : ""
                      }`}
                    >
                    ...
                    <li
                      className={`nav-item ${
                        isPathActive("/admin/live-classes") ? "active" : ""
                      }`}
                    >
                    ...
                    <li
                      className={`nav-item ${
                        isPathStartsWith("/admin/cms") ||
                        isPathActive("/admin/about-us")
                          ? "active"
                          : ""
                      }`}
                    >
                      ...
                      >
                        ...
                        <i
                          className={`bx ${
                            cmsOpen ? "bx-chevron-up" : "bx-chevron-down"
                          } float-end`}
                        />
                      </Link>
                    </li>
                    {cmsOpen && (
                      <ul className="submenu" style={{ paddingLeft: "1rem" }}>
                        ...
                        <li
                          className={`nav-item ${
                            isPathActive("/admin/about-us") ? "active" : ""
                          }`}
                        >
                  ...
                  <ul>
                    <li className="nav-item">
                      <button
                        className="w-100 justify-content-center btn btn-danger d-flex align-items-center gap-2"
