                ...
                <div className="profile-bg">
                  <div className="profile-img">
                    <Link to="/student/student-profile">
                      <img
                        src={
                          profileData.photo ? `${profileData.photo}` : User16
                        }
                        alt="Img"
                        onError={(e) => {
        ...
        />:""} */}
              <div className="settings-menu">
                ...
                <ul>
                  ...
                  <li
                    className={`nav-item ${
                      location.pathname === "/student/student-profile"
                        ? "active"
                        : ""
                    }`}
                  >
                  ...
                  >
                    <Link
                      to="https://novajobs.us/novajobs#tab2"
                      className="nav-link"
                    >
                  ...
                  >
                    <Link
                      to="https://novajobs.us/user/jobs"
                      className="nav-link"
                    >
                      <i className="bx bxs-file"></i>
                      NovaJobs
                  ...
                  <li
                    className={`nav-item ${
                      location.pathname === "/student/student-courses"
                        ? "active"
                        : ""
                    }`}
                  ...
                  <li
                    className={`nav-item ${
                      location.pathname === "/student/student-wishlist" ||
                  ...
                  <li
                    className={`nav-item ${
                      location.pathname === "/student/student-reviews"
                        ? "active"
                        : ""
                    }`}
                  ...
                  <li
                    className={`nav-item ${
                      location.pathname === "/student/student-quiz"
                        ? "active"
                        : ""
                    }`}
                    data-tour="quiz-link"
                  ...
                  <li
                    className={`nav-item ${
                      location.pathname === "/student/student-order-history"
                        ? "active"
                        : ""
                    }`}
                  ...
                  <li
                    className={`nav-item ${
                      location.pathname === "/student/student-qa"
                        ? "active"
                        : ""
                    }`}
                    data-tour="qa-link"
                  ...
                  <li
                    className={`nav-item ${
                      location.pathname === "/student/student-messages"
                        ? "active"
                        : ""
                    }`}
                  >
                  ...
                  <li
                    className={`nav-item ${
                      location.pathname === "/student/join-live-classes"
                        ? "active"
                        : ""
                    }`}
                  >
                ...
                <ul>
                  <li
                    className={`nav-item ${
                      location.pathname === "/student/student-setting" ||
                      location.pathname ===
