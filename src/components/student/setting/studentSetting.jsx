                          ...
                          <div className="input-block">
                            ...
                            <input
                              ...
                              {...register("youtube_profile", {
                                pattern: {
                                  value: /^(https?:\/\/)?(www\.)?(youtube\.com\/(watch\?v=|embed\/|v\/|.+\?v=|.+\/|)([a-zA-Z0-9_-]{11}|[a-zA-Z0-9_-]{1,})|youtu\.be\/([a-zA-Z0-9_-]{11}))/,
                                  message: "Please enter a valid YouTube profile or video URL",
                                },
                              })}
                            />
