              ...
              className="owl-carousel login-slide owl-theme">
                <div className="welcome-login">
                  ...
                  <div className="mentor-course text-center">
                    <h2>
                    Join Us as partner and Grow with us with AI enabled online platform.
                  ...
                  <div className="w-100">
                    ...
                    <form onSubmit={handleSubmit}>
                      <div className="input-block">
                        <label className="form-control-label">Your Company / Institute Name
                        </label>
                        <input
                          type="email"
                      ...
                      <div className="input-block">
                        <label className="form-control-label">Website or Online link if any
                      ...
                      <div className="input-block">
                        <label className="form-control-label">Email ID
                        </label>
                        <input
                          type="email"
                          className="form-control"
                      ...
                      <div className="input-block">
                        <label className="form-control-label">Your Name
                        </label>
                        <input
                          type="email"
                          className="form-control"
                      ...
                      <div className="input-block">
                        <label className="form-control-label">Your Designation
                      ...
                      <div className="input-block">
                        <label className="form-control-label">Contact Number
                      ...
                      <div className="input-block">
                        <label className="form-control-label">Location
