...
//                       <h6>92 Lectures 10:56:11rishi</h6>
//                     </div>
//                   </div>
                ...
                <div className="card-body">
                  ...
                  <div className="instructor-wrap">
                    <div className="about-instructor">
                      ...
                      <div className="instructor-detail">
                        <h5><Link to="/instructor/instructor-profile">Nicole Brown</Link></h5>
                        <p>UX/UI Designer</p>
                      </div>
                    </div>
                    <div className="rating">
                  ...
                  <div className="card">
                    <div className="card-body">
                      ...
                      <div className="video-details">
                        ...
                        <Link to="/checkout" className="btn btn-enroll w-100">Enroll Now</Link>
                      </div>
                    </div>
                  </div>
                </div>
